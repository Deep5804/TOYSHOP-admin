    ...
    try {
      ...
      try {
        const addressResponse = await axios.get(
          `https://toyshop-sooty.vercel.app/api/address/order/${id}`,
          {
            headers: {
              Authorization: `Bearer ${localStorage.getItem("token")}`,
            },
        ...
        setAddressDetails(
          Array.isArray(addressResponse.data) && addressResponse.data.length > 0
        ...
        <div className="mb-6 mt-10">
          ...
          {addressDetails ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <strong>Email:</strong> {addressDetails.email || "N/A"}
              </div>
              <div>
